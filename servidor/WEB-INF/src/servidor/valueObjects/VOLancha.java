...
public class VOLancha extends VOJugador implements Serializable {
		...
		public VOLancha(Boolean estaJugando, int rolJugador, int posX, int posY, int rangVis, int resist, int vel, int rangoAtaque, int artilleria) {
			super();
